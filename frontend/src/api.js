...
export const api = {
  ...
  listServers: (id) => req('GET', `/projects/${id}/servers`),
  saveServers: (id, servers) => req('PUT', `/projects/${id}/servers`, servers),
  ...
  runAgent: (id, payload) => req('POST', `/agents/${id}/run`, payload),
